...
This pretty much sums up how to set up the code for the light trails effect. Below I've written some notes regarding further customization the effect by playing around with the values.
